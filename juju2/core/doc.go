...
...and more generally, when adding to core:
  ...
  * it's fine to import from any subpackage of "github.com/juju/1.25-upgrade/juju2/core"
  * but *never* import from any *other* subpackage of "github.com/juju/1.25-upgrade/juju2"
