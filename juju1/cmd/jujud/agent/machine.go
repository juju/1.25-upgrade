...
import (
	...
	apideployer "github.com/juju/1.25-upgrade/juju1/api/deployer"
	"github.com/juju/1.25-upgrade/juju1/api/metricsmanager"
	apiupgrader "github.com/juju/1.25-upgrade/juju1/api/upgrader"
	"github.com/juju/1.25-upgrade/juju1/apiserver"
	"github.com/juju/1.25-upgrade/juju1/apiserver/params"
	"github.com/juju/1.25-upgrade/juju1/cert"
	"github.com/juju/1.25-upgrade/juju1/cmd/jujud/reboot"
	cmdutil "github.com/juju/1.25-upgrade/juju1/cmd/jujud/util"
	...
	jujunames "github.com/juju/1.25-upgrade/juju1/juju/names"
	"github.com/juju/1.25-upgrade/juju1/juju/paths"
	"github.com/juju/1.25-upgrade/juju1/mongo"
	"github.com/juju/1.25-upgrade/juju1/network"
	"github.com/juju/1.25-upgrade/juju1/provider"
	"github.com/juju/1.25-upgrade/juju1/service"
	"github.com/juju/1.25-upgrade/juju1/service/common"
	...
	"github.com/juju/1.25-upgrade/juju1/worker/addresser"
	"github.com/juju/1.25-upgrade/juju1/worker/apiaddressupdater"
	"github.com/juju/1.25-upgrade/juju1/worker/apicaller"
	"github.com/juju/1.25-upgrade/juju1/worker/authenticationworker"
	"github.com/juju/1.25-upgrade/juju1/worker/certupdater"
	"github.com/juju/1.25-upgrade/juju1/worker/charmrevisionworker"
	"github.com/juju/1.25-upgrade/juju1/worker/cleaner"
	"github.com/juju/1.25-upgrade/juju1/worker/conv2state"
	"github.com/juju/1.25-upgrade/juju1/worker/dblogpruner"
	"github.com/juju/1.25-upgrade/juju1/worker/deployer"
	"github.com/juju/1.25-upgrade/juju1/worker/diskmanager"
	"github.com/juju/1.25-upgrade/juju1/worker/envworkermanager"
	"github.com/juju/1.25-upgrade/juju1/worker/firewaller"
	"github.com/juju/1.25-upgrade/juju1/worker/gate"
	"github.com/juju/1.25-upgrade/juju1/worker/instancepoller"
	"github.com/juju/1.25-upgrade/juju1/worker/localstorage"
	workerlogger "github.com/juju/1.25-upgrade/juju1/worker/logger"
	"github.com/juju/1.25-upgrade/juju1/worker/logsender"
	"github.com/juju/1.25-upgrade/juju1/worker/machiner"
	"github.com/juju/1.25-upgrade/juju1/worker/metricworker"
	"github.com/juju/1.25-upgrade/juju1/worker/minunitsworker"
	"github.com/juju/1.25-upgrade/juju1/worker/networker"
	"github.com/juju/1.25-upgrade/juju1/worker/peergrouper"
	"github.com/juju/1.25-upgrade/juju1/worker/provisioner"
	"github.com/juju/1.25-upgrade/juju1/worker/proxyupdater"
	rebootworker "github.com/juju/1.25-upgrade/juju1/worker/reboot"
	"github.com/juju/1.25-upgrade/juju1/worker/resumer"
	"github.com/juju/1.25-upgrade/juju1/worker/rsyslog"
	"github.com/juju/1.25-upgrade/juju1/worker/singular"
	"github.com/juju/1.25-upgrade/juju1/worker/statushistorypruner"
	"github.com/juju/1.25-upgrade/juju1/worker/storageprovisioner"
	"github.com/juju/1.25-upgrade/juju1/worker/terminationworker"
	"github.com/juju/1.25-upgrade/juju1/worker/toolsversionchecker"
	"github.com/juju/1.25-upgrade/juju1/worker/txnpruner"
	"github.com/juju/1.25-upgrade/juju1/worker/upgrader"
)
...
// "github.com/juju/1.25-upgrade/juju1/apiserver".allowedMethodsAboutToRestore
