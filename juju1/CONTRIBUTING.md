...
```shell
$ go get -d -v github.com/juju/1.25-upgrade/juju1/...
...
3. Hit the "Fork" button on the web page for the juju repo:
    https://github.com/juju/1.25-upgrade/juju1
...
```shell
$ cd $GOPATH/src/github.com/juju/1.25-upgrade/juju1
...
```shell
$ git remote add upstream https://github.com/juju/1.25-upgrade/juju1.git
```
...
```shell
$ godeps -t $(go list github.com/juju/1.25-upgrade/juju1/...) > dependencies.tsv
```
...
```shell
$ go test github.com/juju/1.25-upgrade/juju1/...
```
...
```shell
$ JUJU_NOTEST_MONGOJS=1 go test github.com/juju/1.25-upgrade/juju1/...
```
