...
`$GOPATH/github.com/juju/1.25-upgrade/juju1`. The source for any dependent packages will
also be available inside `$GOPATH`. You can use `git pull --rebase`, or the 
less convenient `go get -u github.com/juju/1.25-upgrade/juju1/...` to update the source
from time to time.
...
=============
    ...
    go install -v github.com/juju/1.25-upgrade/juju1/...
