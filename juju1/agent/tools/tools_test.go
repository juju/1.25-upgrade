...
import (
	...
	coretest "github.com/juju/1.25-upgrade/juju1/tools"
...
func (t *ToolsSuite) TestPackageDependencies(c *gc.C) {
	...
	// Only imports that start with "github.com/juju/1.25-upgrade/juju1" are checked, and the
	// resulting slice has that prefix removed to keep the output short.
	c.Assert(testing.FindJujuCoreImports(c, "github.com/juju/1.25-upgrade/juju1/agent/tools"),
		gc.DeepEquals,
