...
Core package for the API is [rpc](https://github.com/juju/1.25-upgrade/juju1/tree/master/rpc).
...
The standard `Codec` is implemented in [jsoncodec](https://github.com/juju/1.25-upgrade/juju1/tree/master/rpc/jsoncodec).
It uses WebSockets for communication and JSON for encoding. The standard `MethodFinder`
is implemented in [apiserver](https://github.com/juju/1.25-upgrade/juju1/tree/master/state/apiserver) (see
below).
...
The API server is implemented in the package [apiserver](https://github.com/juju/1.25-upgrade/juju1/tree/master/state/apiserver)
...
[apiserver/common](https://github.com/juju/1.25-upgrade/juju1/tree/master/state/apiserver/common). It provides
...
developed in Go, is located in [api](https://github.com/juju/1.25-upgrade/juju1/tree/master/state/api).
