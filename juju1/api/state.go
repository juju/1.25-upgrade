...
import (
	...
	"github.com/juju/1.25-upgrade/juju1/api/addresser"
	"github.com/juju/1.25-upgrade/juju1/api/agent"
	"github.com/juju/1.25-upgrade/juju1/api/base"
	"github.com/juju/1.25-upgrade/juju1/api/charmrevisionupdater"
	"github.com/juju/1.25-upgrade/juju1/api/cleaner"
	"github.com/juju/1.25-upgrade/juju1/api/deployer"
	"github.com/juju/1.25-upgrade/juju1/api/diskmanager"
	"github.com/juju/1.25-upgrade/juju1/api/environment"
	"github.com/juju/1.25-upgrade/juju1/api/firewaller"
	"github.com/juju/1.25-upgrade/juju1/api/instancepoller"
	"github.com/juju/1.25-upgrade/juju1/api/keyupdater"
	apilogger "github.com/juju/1.25-upgrade/juju1/api/logger"
	"github.com/juju/1.25-upgrade/juju1/api/machiner"
	"github.com/juju/1.25-upgrade/juju1/api/networker"
	"github.com/juju/1.25-upgrade/juju1/api/provisioner"
	"github.com/juju/1.25-upgrade/juju1/api/reboot"
	"github.com/juju/1.25-upgrade/juju1/api/resumer"
	"github.com/juju/1.25-upgrade/juju1/api/rsyslog"
	"github.com/juju/1.25-upgrade/juju1/api/storageprovisioner"
	"github.com/juju/1.25-upgrade/juju1/api/uniter"
	"github.com/juju/1.25-upgrade/juju1/api/upgrader"
